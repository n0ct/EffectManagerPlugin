...
public class OrbProjectile extends EntityExperienceOrb implements CustomProjectile, IProjectile {
    ...
    public OrbProjectile(String name, LivingEntity player, Location origin, float power) {
        super(((CraftWorld) origin.getWorld()).getHandle(), origin.getX(), origin.getY(), origin.getZ(), 0);
