...
public class BlockProjectile extends EntityFallingBlock implements CustomProjectile, IProjectile {
    ...
    public BlockProjectile(String name, LivingEntity shooter, int blockId, int data, float power) {
        super(((CraftLivingEntity) shooter).getHandle().world, shooter.getLocation().getX(), shooter.getLocation().getY(), shooter.getLocation().getZ(), Block.e(blockId), data);
        this.shooter = ((CraftLivingEntity) shooter).getHandle();
        this.name = name;
        lastTick = MinecraftServer.currentTick;
        this.a(0.25F, 0.25F);
    ...
    public BlockProjectile(String name, Location origin, LivingEntity shooter, int blockId, int data, float power) {
        super(((CraftLivingEntity) shooter).getHandle().world, shooter.getLocation().getX(), shooter.getLocation().getY(), shooter.getLocation().getZ(), Block.e(blockId), data);
        this.shooter = ((CraftLivingEntity) shooter).getHandle();
        this.name = name;
        this.a(0.25F, 0.25F);
